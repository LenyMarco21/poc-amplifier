 ...
 *
 * Default configuration for TAD5212 codec registers
 * 
 * No licence
 */

#ifndef __TAD5212_DEFAULT_CONFIG_H__
#define __TAD5212_DEFAULT_CONFIG_H__
...
const static tad5212_REG_SW_RESET_t DEFAULT_SW_RESET = 
{
    .reset = 0x1,  /* Software reset */
};

const static tad5212_REG_DEV_MISC_CFG_t DEFAULT_DEV_MISC_CFG_P0 = 
{
...
const static tad5212_REG_DAC_CFG_A0_t DEFAULT_DAC_CFG_A0 = 
{
    .pwr_up_time_de_pop         = 0x05,  /* DAC power-up time of 100 ms (typical) */
    .rseries_de_pop_mid         = 0x03,  /* De-pop resistor series mid value (1K) */
    .rseries_de_pop_int         = 0x00,  /* De-pop resistor series internal value (1K) */
};

const static tad5212_REG_MISC_CFG0_t DEFAULT_MISC_CFG0 =
{
...
const static tad5212_REG_INTF_CFG1_t DEFAULT_INTF_CFG1 = 
{
...
const static tad5212_REG_ASI_CFG1_t DEFAULT_ASI_CFG1 = 
{
...
const static tad5212_REG_PASI_CFG0_t DEFAULT_PASI_CFG0 = 
{
...
const static tad5212_REG_RX_CH1_CFG_t DEFAULT_PASI_RX_CH1_CFG = 
{
...
const static tad5212_REG_RX_CH2_CFG_t DEFAULT_PASI_RX_CH2_CFG = 
{
...
const static tad5212_REG_OUT1x_CFG0_t DEFAULT_OUT1X_CFG0 = 
{
...
const static tad5212_REG_OUT1x_CFG1_t DEFAULT_OUT1X_CFG1 = 
{
    ...
    .out1p_drive                = 0x0,  /* Line out driver with minimum 300Ω single ended impedance */
};

const static tad5212_REG_OUT1x_CFG2_t DEFAULT_OUT1X_CFG2 = 
{
    .dac_ch1_cm_tol             = 0x0,  /* AC-coupled input */
    .ain1p_byp_imp              = 0x0,  /* 4.4kΩ */
    .out1m_lvl_ctrl             = 0x4,  /* 0 dB */
    .out1m_drive                = 0x0,  /* Line out driver with minimum 300Ω single ended impedance */
};

const static tad5212_REG_DAC_CH1A_CFG0_t DEFAULT_DAC_CH1A_CFG0 = 
{
    .dac_ch1a_dvol              = TAD5212_DAC_MIN_VOLUME,  /* Channel 1A digital volume control */
};

const static tad5212_REG_OUT2x_CFG0_t DEFAULT_OUT2X_CFG0 = 
{
...
const static tad5212_REG_OUT2x_CFG1_t DEFAULT_OUT2X_CFG1 = 
{
    ...
    .out2p_drive                = 0x0,  /* Line out driver with minimum 300Ω single ended impedance */
};

const static tad5212_REG_OUT2x_CFG2_t DEFAULT_OUT2X_CFG2 = 
{
    .dac_ch2_cm_tol             = 0x0,  /* AC-coupled input */
    .ain2p_byp_imp              = 0x0,  /* 4.4kΩ */
    .out2m_lvl_ctrl             = 0x4,  /* 0 dB */
    .out2m_drive                = 0x0,  /* Line out driver with minimum 300Ω single ended impedance */
};

const static tad5212_REG_DAC_CH2A_CFG0_t DEFAULT_DAC_CH2A_CFG0 = 
{
    .dac_ch2a_dvol              = TAD5212_DAC_MIN_VOLUME,  /* Channel 2A digital volume control */
};

const static tad5212_REG_CH_EN_t DEFAULT_CH_EN = 
{
    .out_ch4_en                 = 0x0,  /* Disable output channel 4 */
    .out_ch3_en                 = 0x0,  /* Disable output channel 3 */
    .out_ch2_en                 = 0x1,  /* Enable output channel 2 */
    .out_ch1_en                 = 0x1,  /* Enable output channel 1 */
...
const static tad5212_REG_PWR_CFG_t DEFAULT_PWR_CFG = 
{
...
#endif /* __TAD5212_DEFAULT_CONFIG_H__ */